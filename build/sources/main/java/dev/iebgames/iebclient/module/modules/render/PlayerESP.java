...
public class PlayerESP extends Module {
    ...
    private final ColorSetting color = register(new ColorSetting("Color", 0xB4FF5050));
    ...
    public void onRender3D(EventRender3D e) {
        ...
        for (EntityPlayer p : mc.theWorld.playerEntities) {
            if (p != mc.thePlayer) EspRenderHelper.drawEntityBox(p, color.getColor(), e.getPartialTicks());
        }
    }
}
