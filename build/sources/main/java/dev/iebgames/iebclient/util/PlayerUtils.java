...
public final class PlayerUtils {
    ...
    public static void setSpeed(double speed) {
        ...
        double rx = Math.cos(Math.toRadians(yaw + 90.0));
        double rz = Math.sin(Math.toRadians(yaw + 90.0));

        mc.thePlayer.motionX = forward * speed * rx + strafe * speed * rz;
        mc.thePlayer.motionZ = forward * speed * rz - strafe * speed * rx;
    }
}
